...
namespace TakeOutMyBloatware.Utils
{
    ...
    class TokenHelper : IDisposable
    {
        ...
        public static TokenHelper Backup => new TokenHelper("SeBackupPrivilege");
        public static TokenHelper Restore => new TokenHelper("SeRestorePrivilege");
        public static TokenHelper TakeOwnership => new TokenHelper("SeTakeOwnershipPrivilege");

        private readonly string privilegeName;

        private TokenHelper(string privilegeName)
        {
