...
{
    public class DisableTelemetryAction : IActionHandler
    {
        ...
        public DisableTelemetryAction(IUI ui, RemoveServicesAction serviceRemover)
        {
            this.ui = ui;
        ...
        {
            using (TokenHelper.TakeOwnership)
            {
        ...
        private void DisableTelemetryScheduledTasks()
        {
            ...
            new DisableTasksAction(telemetryScheduledTasks, ui).Run();
        }
    }
}
